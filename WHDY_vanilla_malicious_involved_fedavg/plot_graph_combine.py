...
all_rounds_log_files_b = sorted([f for f in listdir(log_folder_b) if f.startswith('comm')])
all_rounds_log_files_m = sorted([f for f in listdir(log_folder_m) if f.startswith('comm')])
all_rounds_log_files_a = None
if log_folder_add:
    all_rounds_log_files_a = sorted([f for f in listdir(log_folder_add) if f.startswith('comm')])
